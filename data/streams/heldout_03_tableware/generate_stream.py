...
STREAM_ID = "heldout_03_tableware"
FRAME_WIDTH = 640
FRAME_HEIGHT = 480
AA = 4
BBOX_PADDING = 2
...
TYPE_SPECS = [
    TypeSpec("plate", "круглая тарелка", "circle", "circle_subclass_01", "Круглая тарелка с широким ободом и плоским центральным полем.", "round_tableware"),
    TypeSpec("bowl", "миска", "circle", "circle_subclass_02", "Миска с толстым ободом, внутренней чашей и дугой глубины.", "round_tableware"),
    TypeSpec("saucer", "блюдце", "circle", "circle_subclass_03", "Блюдце с тонким ободом и центральным кольцом под чашку.", "round_tableware"),
    TypeSpec("oval_platter", "овальное блюдо", "oval", "oval_subclass_01", "Овальное сервировочное блюдо с вытянутым двойным ободом.", ""),
    TypeSpec("square_plate", "квадратная тарелка", "square", "square_subclass_01", "Квадратная тарелка со скругленным контуром и внутренней рамкой.", ""),
    TypeSpec("tray", "компактный поднос", "rectangle", "rectangle_subclass_01", "Поднос с прямоугольным бортом и двумя короткими ручками.", "rectangle_tableware"),
    TypeSpec("folded_napkin", "сложенная салфетка", "rectangle", "rectangle_subclass_02", "Компактная сложенная салфетка с диагональным сгибом и окантовкой.", "rectangle_tableware"),
    TypeSpec("triangle_plate", "треугольная тарелка", "triangle", "triangle_subclass_01", "Треугольная тарелка со скругленным двойным ободом.", ""),
    TypeSpec("cup", "чашка", "undefined", "undefined_subclass_01", "Чашка сбоку с верхним эллипсом и отдельной ручкой.", "undefined_tableware"),
    TypeSpec("spoon", "ложка", "undefined", "undefined_subclass_02", "Ложка с овальной чашей и узкой длинной ручкой.", "undefined_tableware"),
]
...
PLATE1 = lambda: pl("plate", (55, 72), body_color="#E8C77B", difficulty_tags="similar_subclass,border_near")
PLATE2 = lambda: pl("plate", (230, 95), slot=2, body_color="#D9B76C", difficulty_tags="count_change,similar_subclass")
BOWL = lambda: pl("bowl", (330, 72), body_color="#71C1B4", difficulty_tags="similar_subclass,reappearance")
SAUCER = lambda scale=1.0: pl("saucer", (430, 95), scale=scale, body_color="#D98A75", difficulty_tags="similar_subclass,reappearance" + (",scale" if scale != 1 else ""))
PLATTER = lambda: pl("oval_platter", (550, 72), body_color="#B69CDC")
SQUARE = lambda: pl("square_plate", (90, 205), rotation=6, body_color="#83B7D8")
TRAY0 = lambda: pl("tray", (225, 195), body_color="#C79B68", difficulty_tags="similar_subclass")
TRAY1 = lambda: pl("tray", (300, 195), body_color="#C79B68", difficulty_tags="position_change,similar_subclass")
NAPKIN0 = lambda: pl("folded_napkin", (470, 205), body_color="#75C6A7", difficulty_tags="similar_subclass")
NAPKIN1 = lambda: pl("folded_napkin", (470, 205), rotation=25, scale=0.85, body_color="#75C6A7", difficulty_tags="rotation,scale,similar_subclass")
TRIANGLE = lambda: pl("triangle_plate", (535, 355), rotation=-8, body_color="#D9A0BC")
CUP = lambda color="#DB786D": pl("cup", (75, 355), body_color=color, difficulty_tags="reappearance")
SPOON1 = lambda: pl("spoon", (225, 340), rotation=12, body_color="#D9E0E3")
SPOON2 = lambda: pl("spoon", (355, 390), slot=2, rotation=-18, body_color="#C4D0D5", difficulty_tags="count_change")


SCENES: list[list[Placement]] = [
    [PLATE1(), BOWL(), CUP(), SPOON1()],
    [PLATE1(), BOWL(), CUP(), SPOON1(), SAUCER()],
    [pl("plate", (130, 72), body_color="#E8C77B", difficulty_tags="position_change,similar_subclass"), BOWL(), CUP(), SPOON1(), SAUCER()],
    [pl("plate", (130, 72), body_color="#E8C77B", difficulty_tags="position_change,similar_subclass"), BOWL(), CUP(), SPOON1(), SPOON2(), SAUCER()],
    [pl("plate", (130, 72), body_color="#E8C77B"), CUP(), SPOON1(), SPOON2(), SAUCER()],
    [pl("plate", (130, 72), body_color="#E8C77B"), CUP(), SPOON1(), SPOON2(), SAUCER(), PLATTER()],
    [pl("plate", (130, 72), body_color="#E8C77B"), CUP("#78B8C7"), SPOON1(), SPOON2(), SAUCER(), PLATTER()],
    [pl("plate", (130, 72), body_color="#E8C77B"), CUP("#78B8C7"), SPOON1(), SPOON2(), SAUCER(), PLATTER(), SQUARE()],
    [pl("plate", (130, 72), body_color="#E8C77B"), CUP("#78B8C7"), SPOON1(), SPOON2(), SAUCER(1.25), PLATTER(), SQUARE()],
    [pl("plate", (130, 72), body_color="#E8C77B"), CUP("#78B8C7"), SPOON1(), SPOON2(), SAUCER(1.25), PLATTER(), SQUARE(), TRAY0()],
    [pl("plate", (130, 72), body_color="#E8C77B"), CUP("#78B8C7"), SPOON1(), SPOON2(), SAUCER(1.25), PLATTER(), SQUARE(), TRAY1()],
    [pl("plate", (130, 72), body_color="#E8C77B"), CUP("#78B8C7"), SPOON1(), SPOON2(), SAUCER(1.25), PLATTER(), SQUARE(), TRAY1(), NAPKIN0()],
    [pl("plate", (130, 72), body_color="#E8C77B"), CUP("#78B8C7"), SPOON1(), SPOON2(), SAUCER(1.25), PLATTER(), SQUARE(), TRAY1(), NAPKIN1()],
    [pl("plate", (130, 72), body_color="#E8C77B"), CUP("#78B8C7"), SPOON1(), SPOON2(), SAUCER(1.25), PLATTER(), SQUARE(), TRAY1(), NAPKIN1(), TRIANGLE()],
    [pl("plate", (130, 72), body_color="#E8C77B"), SPOON1(), SPOON2(), SAUCER(1.25), PLATTER(), SQUARE(), TRAY1(), NAPKIN1(), TRIANGLE()],
    [pl("plate", (130, 72), body_color="#E8C77B"), PLATE2(), SPOON1(), SPOON2(), SAUCER(1.25), PLATTER(), SQUARE(), TRAY1(), NAPKIN1(), TRIANGLE()],
    [pl("plate", (130, 72), body_color="#E8C77B"), PLATE2(), CUP("#78B8C7"), SPOON1(), SPOON2(), SAUCER(1.25), PLATTER(), SQUARE(), TRAY1(), NAPKIN1(), TRIANGLE()],
    [pl("plate", (130, 72), body_color="#E8C77B"), PLATE2(), BOWL(), CUP("#78B8C7"), SPOON1(), SPOON2(), SAUCER(1.25), PLATTER(), SQUARE(), TRAY1(), NAPKIN1(), TRIANGLE()],
    [pl("plate", (130, 72), body_color="#E8C77B"), PLATE2(), BOWL(), CUP("#78B8C7"), SPOON1(), SPOON2(), PLATTER(), SQUARE(), TRAY1(), NAPKIN1(), TRIANGLE()],
    [pl("plate", (130, 72), body_color="#E8C77B"), PLATE2(), BOWL(), CUP("#78B8C7"), SPOON1(), SAUCER(), PLATTER(), SQUARE(), TRAY1(), NAPKIN1(), TRIANGLE()],
]

FRAME_NOTES = [
    "Начальная сцена: тарелка, миска, чашка и ложка.", "Появляется блюдце.", "Тарелка перемещается на 75 px.",
    "Добавляется вторая ложка.", "Исчезает миска.", "Появляется овальное блюдо.", "Меняется цвет чашки.",
    "Появляется квадратная тарелка.", "Блюдце увеличивается вокруг центра.", "Появляется поднос.",
    "Поднос перемещается на 75 px.", "Появляется сложенная салфетка.", "Салфетка уменьшается и поворачивается вокруг центра.",
    "Появляется треугольная тарелка.", "Исчезает чашка.", "Добавляется вторая круглая тарелка.",
    "Возвращается чашка.", "Возвращается миска.", "Исчезает блюдце.",
    "Блюдце возвращается; число ложек уменьшается до одной.",
]

POSITION_CHANGES = {
    3: {"circle_subclass_01"},
    11: {"rectangle_subclass_01"},
}
...
def draw_plate(color: str) -> Image.Image:
    image, draw = new_asset(70, 70); outline = shade(color, 0.5)
    draw.ellipse(scaled_box((2, 2, 68, 68)), fill=color, outline=outline, width=scaled(3))
    draw.ellipse(scaled_box((13, 13, 57, 57)), fill=shade(color, 1.12), outline=outline, width=scaled(2))
    draw.arc(scaled_box((18, 18, 52, 52)), 190, 305, fill="#F2E5C9", width=scaled(2)); return image


def draw_bowl(color: str) -> Image.Image:
    image, draw = new_asset(68, 68); outline = shade(color, 0.45)
    draw.ellipse(scaled_box((2, 6, 66, 62)), fill=color, outline=outline, width=scaled(3))
    draw.ellipse(scaled_box((10, 12, 58, 47)), fill=shade(color, 0.68), outline=outline, width=scaled(2))
    draw.arc(scaled_box((12, 25, 56, 58)), 5, 175, fill=shade(color, 1.2), width=scaled(3)); return image


def draw_saucer(color: str) -> Image.Image:
    image, draw = new_asset(64, 64); outline = shade(color, 0.48)
    draw.ellipse(scaled_box((2, 5, 62, 59)), fill=color, outline=outline, width=scaled(3))
    draw.ellipse(scaled_box((17, 17, 47, 47)), fill=shade(color, 1.1), outline=outline, width=scaled(2))
    draw.ellipse(scaled_box((23, 23, 41, 41)), outline=shade(color, 0.7), width=scaled(2)); return image


def draw_oval_platter(color: str) -> Image.Image:
    image, draw = new_asset(104, 58); outline = shade(color, 0.48)
    draw.ellipse(scaled_box((2, 3, 102, 55)), fill=color, outline=outline, width=scaled(3))
    draw.ellipse(scaled_box((13, 12, 91, 46)), fill=shade(color, 1.1), outline=outline, width=scaled(2)); return image


def draw_square_plate(color: str) -> Image.Image:
    image, draw = new_asset(72, 72); outline = shade(color, 0.48)
    draw.rounded_rectangle(scaled_box((2, 2, 70, 70)), radius=scaled(10), fill=color, outline=outline, width=scaled(3))
    draw.rounded_rectangle(scaled_box((13, 13, 59, 59)), radius=scaled(7), fill=shade(color, 1.1), outline=outline, width=scaled(2)); return image


def draw_tray(color: str) -> Image.Image:
    image, draw = new_asset(110, 58); outline = shade(color, 0.45)
    draw.rounded_rectangle(scaled_box((7, 4, 103, 54)), radius=scaled(8), fill=color, outline=outline, width=scaled(3))
    draw.rounded_rectangle(scaled_box((17, 13, 93, 45)), radius=scaled(5), fill=shade(color, 1.1), outline=outline, width=scaled(2))
    draw.line(scaled_points([(2, 20), (10, 20)]), fill=outline, width=scaled(5)); draw.line(scaled_points([(100, 38), (108, 38)]), fill=outline, width=scaled(5)); return image


def draw_folded_napkin(color: str) -> Image.Image:
    image, draw = new_asset(66, 48); outline = shade(color, 0.5)
    draw.rounded_rectangle(scaled_box((2, 2, 64, 46)), radius=scaled(5), fill=color, outline=outline, width=scaled(3))
    draw.polygon(scaled_points([(4, 4), (42, 4), (63, 25), (63, 44)]), fill=shade(color, 1.12), outline=outline)
    draw.line(scaled_points([(7, 40), (57, 40)]), fill=shade(color, 0.72), width=scaled(2)); return image


def draw_triangle_plate(color: str) -> Image.Image:
    image, draw = new_asset(80, 74); outline = shade(color, 0.48)
    draw.polygon(scaled_points([(40, 3), (76, 68), (4, 68)]), fill=color, outline=outline, width=scaled(3))
    draw.polygon(scaled_points([(40, 17), (63, 58), (17, 58)]), fill=shade(color, 1.12), outline=outline, width=scaled(2)); return image


def draw_cup(color: str) -> Image.Image:
    image, draw = new_asset(78, 68); outline = shade(color, 0.45)
    draw.rounded_rectangle(scaled_box((5, 13, 53, 62)), radius=scaled(8), fill=color, outline=outline, width=scaled(3))
    draw.ellipse(scaled_box((5, 7, 53, 25)), fill=shade(color, 1.12), outline=outline, width=scaled(2))
    draw.arc(scaled_box((45, 20, 75, 55)), 255, 105, fill=outline, width=scaled(6)); draw.arc(scaled_box((47, 23, 70, 51)), 255, 105, fill=shade(color, 1.15), width=scaled(3)); return image


def draw_spoon(color: str) -> Image.Image:
    image, draw = new_asset(102, 30); outline = "#64737B"
    draw.ellipse(scaled_box((3, 3, 31, 27)), fill=color, outline=outline, width=scaled(2))
    draw.rounded_rectangle(scaled_box((26, 11, 99, 19)), radius=scaled(4), fill=color, outline=outline, width=scaled(2))
    draw.arc(scaled_box((8, 7, 26, 23)), 80, 280, fill="#F4F6F7", width=scaled(2)); return image


DRAWERS = {
    "plate": draw_plate, "bowl": draw_bowl, "saucer": draw_saucer,
    "oval_platter": draw_oval_platter, "square_plate": draw_square_plate,
    "tray": draw_tray, "folded_napkin": draw_folded_napkin,
    "triangle_plate": draw_triangle_plate, "cup": draw_cup, "spoon": draw_spoon,
}
...
def generate() -> None:
    ...
    manifest = {
        ...
        "stream_id": STREAM_ID,
        "scene_description": "Independent controlled held-out tableware stream with ten local visual types, irregular placement, compact folded napkin, reappearance, count changes, motion, rotation, scale, and color variations.",
        "ordering": "manifest",
        "frames": [
